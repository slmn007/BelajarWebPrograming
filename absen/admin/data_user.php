...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">List Data Login User</h1>
			</div>
		</div><!--/.row-->
			<div class="col-md-6">
		...
		<div class="col-md-12 table-responsive-md">
			...
			<a href="formTambahUser.php" class="btn btn-sm btn-success">Tambah Data</a>
				<thead>
					<tr>
						<th>No</th>
						<th>Username</th>
				...
				<tbody>
					...
					<tr>
						...
						<td><?= $row['password']; ?></td>
						<td>
							<a class="btn btn-primary" href="ubahUser.php?id_login=<?= $row['id_login'];?>" onclick="return confirm('yakin ingin mengubah data <?= $row['username'];?>?'); ">Ubah</a>
							<a class="btn btn-danger" href="hapusUser.php?id_login=<?= $row['id_login'];?>" onclick="return confirm('yakin ingin menghapus data <?= $row['username'];?>?'); ">Hapus</a>
						</td>
					</tr>
					<?php $i++; ?>
					<?php endforeach;?>
